...
const draft = JSON.parse(fs.readFileSync('scratch/cat3_batch2_translations.json', 'utf8'));
...
console.log(`Updated ES count: ${esData.length} (expected 691)`);
console.log(`Updated PT count: ${ptData.length} (expected 691)`);
