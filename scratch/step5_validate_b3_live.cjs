...
console.log('=== STEP 5: POST-WRITE RE-VALIDATION FOR BATCH 3 (FRESH FROM DISK) ===\n');
...
if (failures === 0) {
  console.log('STATUS: STEP 5 VALIDATION PASSED WITH 0 FAILURES');
} else {
  console.error('STATUS: STEP 5 VALIDATION FAILED');
  process.exit(1);
}
