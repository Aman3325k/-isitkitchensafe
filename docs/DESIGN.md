...
- **Error** (`{colors.error}` — #b91c1c), **Error Border** (`{colors.error-border}` — #f87171), and **Error Bg** (`{colors.error-bg}` — #fef2f2): Form errors and high-risk safety warnings.
- **Warning** (`{colors.warning}` — #a16207), **Warning Border** (`{colors.warning-border}` — #facc15), and **Warning Bg** (`{colors.warning-bg}` — #fefce8): Cautions and conditional safety states.
